...
<html lang="en">
    <head>
        ...
        <!-- https://www.webslesson.info/2022/01/php-mysql-inline-editing-using-vanilla-javascript-with-bootstrap-5.html -->
        ...
        <title>Inline Editing PHP</title>
    </head>
    <body>

        <div class="container">
            <h1 class="mt-5 mb-5 text-center text-primary">Inline Editing PHP</h1>
            <div class="card">
